"""Módulo para crear características agregadas de clientes y productos."""

import pandas as pd


def create_customer_features(df):
    """Crear características agregadas por cliente para enriquecer dataset."""
...
def create_product_features(df):
    ...
    product_features["Product_Popularity_Score"] = (
        ...
        / product_features["Product_Transaction_Count"].sum()
    )

    product_features["Product_Revenue_Per_Transaction"] = (
        product_features["Product_Total_Revenue"]
        / product_features["Product_Transaction_Count"]
    )
